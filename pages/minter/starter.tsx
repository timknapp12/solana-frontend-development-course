...
const nftImageUrl =
  'https://nathan-galindo.vercel.app/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fimage-1.a2303c84.jpg&w=384&q=75';
    ...
    const response = await fetch(apiUrl, {
      ...
      body: JSON.stringify({
        ...
        params: {
          ...
          sellerFeeBasisPoints: 6900, // 69% royalty fee
        },
      }),
    });
  ...
  React.useEffect(() => {
    setApiUrl(
      connection.rpcEndpoint.includes('devnet')
        ...
        : (process.env.NEXT_PUBLIC_MAINNET_URL as string)
    );
  }, [connection]);
    ...
    <main className='max-w-7xl grid grid-cols-1 sm:grid-cols-6 gap-4 p-4 text-white'>
      ...
      >
        <div className='flex justify-between items-center'>
          <h2 className='text-lg sm:text-2xl font-semibold'>cNFT Minter 🖼️</h2>
          <button
            type='submit'
